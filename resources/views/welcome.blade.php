                            ...
                            <div class="wrapper">
                                ...
                                <div class="form-inner pop-slide">
                                    <div class="row">
                                        ...
                                        <div class="col-6"style="text-align: center;">
                                            <label class="form-input" for="by_">
                                                <input type="radio" name="by_" value="Docente" autocomplete="off">
                                                Docente
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="1" autocomplete="off">
                                                1
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="2" autocomplete="off">
                                                2
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="3" autocomplete="off">
                                                3
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="4" autocomplete="off">
                                                4
                                            </label>
                                        ...
                                        <div class="col-4">
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="5" autocomplete="off">
                                                5
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="6" autocomplete="off">
                                                6
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="7" autocomplete="off">
                                                7
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="8" autocomplete="off">
                                                8
                                            </label>
                                        ...
                                        <div class="col-4">
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="9" autocomplete="off">
                                                9
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="10" autocomplete="off">
                                                10
                                            </label>
                                            <label class="form-input" for="semestre">
                                                <input type="radio" name="semestre" value="11" autocomplete="off">
                                                11
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="wrapper">
                                ...
                                <div class="form-inner">
                                    <input class="form-control" name="newarea" id="newarea"
                                        style="display:none; line-height: 2.7" placeholder="Ingrese el nombre del área">
                                </div>
